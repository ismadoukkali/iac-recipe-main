...
@minLength(3)
@maxLength(40)
param appServiceAppName1 string = 'idoukkali-assignment-app-BE-bicep'
@sys.description('The second Web App name.')
@minLength(3)
@maxLength(40)
param appServiceAppName2 string = 'idoukkali-assignment-app-FE-bicep'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(40)
param appServicePlanName string = 'idoukkali-assignment-ASP-bicep'
@sys.description('The Storage Account name.')
@minLength(3)
@maxLength(40)
param storageAccountName string = 'idoukkalistorage'
@allowed([
  'nonprod'
  'prod'
])
